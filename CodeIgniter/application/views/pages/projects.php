    ...
    <ol start="<?php echo $number;?>">
        ...
        <li style="height: 45px;">
            ...
            <div class="projects" style="float: right; position: relative; top:<?php echo $top; ?>">
                ...
                <a href="<?php echo base_url(); ?>index.php/pages/view/download_statistic/<?php echo $list->id; ?>" target="_blank" class="box-button" style="margin: 5px 10px 0 10px;">Download Statistic</a>
            </div>
            <div class="clear"></div>
        </li>
