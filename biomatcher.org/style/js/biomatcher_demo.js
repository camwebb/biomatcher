function biomatcher(yourURL,token){
    ...
    $('#biomatcher_captcha').append('<iframe src="http://biomatcher.org/index.php/captcha/frame?demo=true&token='+token+'&yoururl='+yourURL+'" height="630px" width="761px" frameborder="0" ></iframe>');
    ...
    $('.popup_close').css({
        ...
        height: "36px",
        cursor: "pointer",
        background: "url('http://biomatcher.org/demo/img/sprite.png')" 
    });
}
