function biomatcher(url,token){
    ...
    $('#biomatcher_captcha').append('<iframe name="'+url+'" title="'+token+'" src="http://biomatcher.org/index.php/captcha/frame" height="630px" width="761px" frameborder="0" ></iframe>');
    $('.overlay').css({
        position: "fixed",
        top: "0px",
        bottom: "0px",
